          ...
          <div className="container">
            ...
            >
              ...
              <ul className="list-disc list-outside">
                ...
                <li>
                  <p className="text-base">
                    ...
                    refers to MineSweeper, the software program provided by the
                    Company.
                  </p>
                </li>
                <li>
                  <p className="text-base">
                    ...
                    this Agreement) refers to MineSweeper.
                  </p>
                </li>
                <li>
                  <p className="text-base">
                    <strong>Country</strong> refers to: Ecuador
                  </p>
                </li>
                <li>
                  <p className="text-base">
              ...
              <p className="text-base">
                ...
                Internet Protocol address (e.g. IP address), unique device
              ...
              <h2 className="text-lg font-semibold text-left my-2">
                Contact Us
              </h2>
              <p className="text-base">
